...
public class Signup2 extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String contact = t1.getText();
        String nidNum = t2.getText();
        ...
        try{
            if(t2.getText().equals("")){
                ...
                Conn c1 = new Conn();
                String q1 = "insert into signup2 values('"+formno+"','"+religion+"','"+category+"','"+income+"','"+education+"','"+occupation+"','"+contact+"','"+nidNum+"','"+scitizen+"','"+eaccount+"')";
...
public class Signup2 extends JFrame implements ActionListener{
    ...
    JLabel l1,l2,l3,l4,l5,l6,l9,l10,l11,l12,l13;
    JButton b;
    JTextField t2;
    JRadioButton r1,r2,r3,r4;
    JComboBox c1,c2,c3,c4,c5;
    ...
    Signup2(String formno){
        ...
        String religion[] = {"Muslim","Hindu","Other"};
        c1 = new JComboBox(religion);
        c1.setBackground(Color.WHITE);
        c1.setFont(new Font("Raleway", Font.BOLD, 14));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(t2.getText().equals("")){
                ...
                Conn c1 = new Conn();
                String q1 = "insert into signup2 values('"+formno+"','"+religion+"','"+category+"','"+income+"','"+education+"','"+occupation+"','"+scitizen+"','"+eaccount+"')";
                c1.s.executeUpdate(q1);
